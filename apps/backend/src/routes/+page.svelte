...
<span class="text-blue-400">scripts:</span>
  ...
  <span class="text-blue-400">test-all:</span> <span class="text-green-400">"knot run test --all"</span></code></pre>
			...
			<div class="space-y-4">
				...
				<div class="bg-muted/30 rounded-lg p-4">
					<div class="text-sm text-muted-foreground mb-2">Terminal</div>
					<pre class="text-sm font-mono bg-black/90 text-green-400 p-3 rounded overflow-x-auto"><code>$ knot init:package utils --team myteam --template @typescript-lib
📥 Downloading template package: @typescript-lib
✅ Successfully applied template
📦 Created package: @myteam/utils</code></pre>
				</div>
				<div class="bg-muted/30 rounded-lg p-4">
