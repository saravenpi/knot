					...
					<div class="grid grid-cols-1 md:grid-cols-4 gap-8">
						...
						<div class="space-y-4">
							...
							<div class="flex space-x-4">
								<a href="https://github.com/saravenpi/knot" class="text-gray-400 hover:text-white transition-colors">
								...
								<a href="https://twitter.com/knotspace" class="text-gray-400 hover:text-white transition-colors">
									<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
