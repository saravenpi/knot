...
<svelte:head>
	<title>Cookie Policy - Knot Space</title>
	<meta name="description" content="Knot Space Cookie Policy - How we use cookies and similar technologies" />
</svelte:head>
			...
			<div class="flex">
				...
				<div class="ml-3">
					<p class="text-sm text-blue-700">
						This Cookie Policy explains how Knot Space uses cookies and similar technologies to provide and improve our service.
					</p>
				</div>
			</div>
		</div>
		...
		<section class="mb-12">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				<div class="border rounded-lg p-6">
					...
					<ul class="text-sm space-y-2">
						<li>• <a href="#" class="text-blue-600 hover:text-blue-800">Chrome Cookie Settings</a></li>
						<li>• <a href="#" class="text-blue-600 hover:text-blue-800">Firefox Cookie Settings</a></li>
						<li>• <a href="#" class="text-blue-600 hover:text-blue-800">Safari Cookie Settings</a></li>
						<li>• <a href="#" class="text-blue-600 hover:text-blue-800">Edge Cookie Settings</a></li>
					</ul>
				</div>
		...
		<section class="mb-12 bg-gray-50 rounded-lg p-6">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<div>
					...
					<a href="https://github.com/saravenpi/knot/issues" class="text-blue-600 hover:text-blue-800">Report on GitHub</a>
				</div>
			</div>
		</section>
	</div>
